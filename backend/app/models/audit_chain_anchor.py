...
class AuditChainAnchor(Base):
    ...
    last_audit_log_id: Mapped[int] = mapped_column(Integer, nullable=False, index=True)
    ...
    anchor_reference: Mapped[str] = mapped_column(String(500), default="", nullable=False)
